...
class PlanesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create plane" do
    assert_difference('Plane.count') do
      post planes_url, params: { plane: { airport_id: @plane.airport_id, name: @plane.name } }
    end
  ...
  test "should update plane" do
    patch plane_url(@plane), params: { plane: { airport_id: @plane.airport_id, name: @plane.name } }
